...
are likely application dependent, but here are some general guidelines:
  ...
  - If one or more of the spending conditions consist of just a single
    ...
    branch. If that is inacceptable, pick as internal key a "Nothing Up
    My Sleeve" (NUMS) point, i.e., a point with unknown discrete
    logarithm. One example of such a point is *H =
    lift\_x(0x50929b74c1a04954b78b4b6035e97a5e078a5a0f28ec96d547bfee9ace803ac0)*
    which is
