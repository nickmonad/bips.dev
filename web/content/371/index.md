...
|-|-|-|-|-|-|-|-|-|
|Taproot Key Spend Signature|`PSBT_IN_TAP_KEY_SIG = 0x13`|None|No key data <sup id="cite_ref_1"><a href="#cite_ref_1">1</a></sup>|`<64 or 65 byte signature>`|The 64 or 65 byte Schnorr signature for key path spending a Taproot output. Finalizers should remove this field after `PSBT_IN_FINAL_SCRIPTWITNESS` is constructed.|||0, 2|
...
|Taproot Internal Key|`PSBT_IN_TAP_INTERNAL_KEY = 0x17`|None|No key data|`<32 byte xonlypubkey>`|The X-only pubkey used as the internal key in this output.<sup id="cite_ref_2"><a href="#cite_ref_2">2</a></sup> Finalizers should remove this field after `PSBT_IN_FINAL_SCRIPTWITNESS` is constructed.|||0, 2|
