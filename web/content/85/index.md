...
_"One Seed to rule them all,_
_One Key to find them,_
_One Path to bring them all,_
...
Derivation path uses the format `m/83696968'/{app_no}'/{index}'` where _{app_no}_ is the path for the application, and _{index}_ is the index.
...
<a href="https://datatracker.ietf.org/doc/html/rfc4648" target="_blank">Base64</a> encode the all 64 bytes of entropy.
