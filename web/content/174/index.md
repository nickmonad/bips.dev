...
| Previous TXID                      | `PSBT_IN_PREVIOUS_TXID = 0x0e`            | None                                                                                                                | No key data                                                                                                                                                                         | `<32 byte txid>`                                                                                                             | 32 byte txid of the previous transaction whose output at PSBT\_IN\_OUTPUT\_INDEX is being spent.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          | 2                            | 0                            | 2                           | [370](/370) |
| Spent Output Index                 | `PSBT_IN_OUTPUT_INDEX = 0x0f`             | None                                                                                                                | No key data                                                                                                                                                                         | `<32-bit little endian uint index>`                                                                                          | 32 bit little endian integer representing the index of the output being spent in the transaction with the txid of PSBT\_IN\_PREVIOUS\_TXID.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               | 2                            | 0                            | 2                           | [370](/370) |
