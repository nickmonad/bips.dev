...
|-|-|-|-|-|-|-|-|-|
|Unsigned Transaction|`PSBT_GLOBAL_UNSIGNED_TX = 0x00`|None|No key data|`<bytes transaction>`|The transaction in network serialization. The scriptSigs and witnesses for each input must be empty. The transaction must be in the old serialization format (without witnesses).|0|2|0|
...
|PSBT Version Number|`PSBT_GLOBAL_VERSION = 0xFB`|None|No key data|`<32-bit little endian uint version>`|The 32-bit little endian unsigned integer representing the version number of this PSBT. If omitted, the version number is 0.|2||0, 2|
...
|Name|`<keytype>`|`<keydata>`|`<keydata>` Description|`<valuedata>`|`<valuedata>` Description|Versions Requiring Inclusion|Versions Requiring Exclusion|Versions Allowing Inclusion|
|-|-|-|-|-|-|-|-|-|
|Non-Witness UTXO|`PSBT_IN_NON_WITNESS_UTXO = 0x00`|None|No key data|`<bytes transaction>`|The transaction in network serialization format the current input spends from. This should be present for inputs that spend non-segwit outputs and can be present for inputs that spend segwit outputs. An input can have both `PSBT_IN_NON_WITNESS_UTXO` and `PSBT_IN_WITNESS_UTXO`. <sup id="cite_ref_1"><a href="#cite_ref_1">1</a></sup>|||0, 2|
|Witness UTXO|`PSBT_IN_WITNESS_UTXO = 0x01`|None|No key data|`<64-bit little endian int amount> <compact size uint scriptPubKeylen> <bytes scriptPubKey>`|The entire transaction output in network serialization which the current input spends from. This should only be present for inputs which spend segwit outputs, including P2SH embedded ones. An input can have both `PSBT_IN_NON_WITNESS_UTXO` and `PSBT_IN_WITNESS_UTXO`|||0, 2|
...
|Redeem Script|`PSBT_IN_REDEEM_SCRIPT = 0x04`|None|No key data|`<bytes redeemScript>`|The redeemScript for this input if it has one.|||0, 2|
|Witness Script|`PSBT_IN_WITNESS_SCRIPT = 0x05`|None|No key data|`<bytes witnessScript>`|The witnessScript for this input if it has one.|||0, 2|
...
|Finalized scriptSig|`PSBT_IN_FINAL_SCRIPTSIG = 0x07`|None|No key data|`<bytes scriptSig>`|The Finalized scriptSig contains a fully constructed scriptSig with signatures and any other scripts necessary for the input to pass validation.|||0, 2|
|Finalized scriptWitness|`PSBT_IN_FINAL_SCRIPTWITNESS = 0x08`|None|No key data|`<bytes scriptWitness>`|The Finalized scriptWitness contains a fully constructed scriptWitness with signatures and any other scripts necessary for the input to pass validation.|||0, 2|
|RIPEMD160 preimage|`PSBT_IN_RIPEMD160 = 0x0a`|`<20-byte hash>`|The resulting hash of the preimage|`<bytes preimage>`|The hash preimage, encoded as a byte vector, which must equal the key when run through the `RIPEMD160` algorithm|||0, 2|
|SHA256 preimage|`PSBT_IN_SHA256 = 0x0b`|`<32-byte hash>`|The resulting hash of the preimage|`<bytes preimage>`|The hash preimage, encoded as a byte vector, which must equal the key when run through the `SHA256` algorithm|||0, 2|
|HASH160 preimage|`PSBT_IN_HASH160 = 0x0c`|`<20-byte hash>`|The resulting hash of the preimage|`<bytes preimage>`|The hash preimage, encoded as a byte vector, which must equal the key when run through the `SHA256` algorithm followed by the `RIPEMD160` algorithm|||0, 2|
|HASH256 preimage|`PSBT_IN_HASH256 = 0x0d`|`<32-byte hash>`|The resulting hash of the preimage|`<bytes preimage>`|The hash preimage, encoded as a byte vector, which must equal the key when run through the `SHA256` algorithm twice|||0, 2|
...
|Name|`<keytype>`|`<keydata>`|`<keydata>` Description|`<valuedata>`|`<valuedata>` Description|Versions Requiring Inclusion|Versions Requiring Exclusion|Versions Allowing Inclusion|
|-|-|-|-|-|-|-|-|-|
|Redeem Script|`PSBT_OUT_REDEEM_SCRIPT = 0x00`|None|No key data|`<bytes redeemScript>`|The redeemScript for this output if it has one.|||0, 2|
|Witness Script|`PSBT_OUT_WITNESS_SCRIPT = 0x01`|None|No key data|`<bytes witnessScript>`|The witnessScript for this output if it has one.|||0, 2|
...
As discussed in <a href="Handling Duplicated Keys" target="_blank">Handling Duplicated Keys</a>, when a combiner is asked to combine PSBTs with conflicting fields,
...
*  **1.4.4** (2026-09-23):
    *  Clarify that combiner test vectors must pass in any input order unless there are conflicting fields
    *  Add combiner test vectors for preserving PSBT_IN_SIGHASH_TYPE
*  **1.4.3** (2026-07-16):
    *  Clarify that combining PSBTs is commutative unless they have conflicting fields
*  **1.4.2** (2026-04-08):
...
Given both of the above PSBTs, a combiner must create this PSBT. A combiner must produce the given result for any order of its inputs, unless there are conflicting fields. The current combiner test vectors do not have conflicting fields:
...
Given these two PSBTs:

*  Bytes in Hex: <pre></pre>
    *  Base64 String: <pre></pre>


*  Bytes in Hex: <pre></pre>
...
A combiner must create this PSBT:
