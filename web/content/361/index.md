...
|B|At a predetermined block height, nodes reject transactions that rely on ECDSA/Schnorr keys.|Everyone holding or accepting BTC.|2 years after Phase A activation.|
|C|Users with frozen quantum vulnerable funds and a HD wallet seed phrase can construct a quantum safe proof to recover funds.|Users who failed to migrate funds before Phase B.|TBD pending research, demand, and consensus.|
