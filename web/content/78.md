...
### `<span id="optional-params">`{=html}`</span>`{=html}Optional parameters
...
### `<span id="fee-output">`{=html}`</span>`{=html}Fee output
...
### `<span id="spare-change">`{=html}`</span>`{=html}Spare change donation
...
### `<span id="output-substitution">`{=html}`</span>`{=html}Payment output substitution
...
### `<span id="unsecured-payjoin">`{=html}`</span>`{=html}Unsecured payjoin server
...
### `<span id="probing-attack">`{=html}`</span>`{=html}On the receiver side: UTXO probing attack
...
## `<span id="reference-impl">`{=html}`</span>`{=html}Reference sender\'s implementation
...
## `<span id="test-vectors">`{=html}`</span>`{=html}Test vectors
