...
|-|-|-|
|OP_VERIFY|wordspan(A) * 2|COMPARINGZERO|
|OP_NOT|wordspan(A) * 2|COMPARINGZERO|
|OP_0NOTEQUAL|wordspan(A) * 2|COMPARINGZERO|
...
|OP_IFDUP|wordspan(A) * 2 + length(A) * 3|COMPARINGZERO + COPYING|
|OP_DUP|length(A) * 3|COPYING|
|OP_OVER|length(B) * 3|COPYING|
|OP_PICK|wordspan(A) * 2 + length(A-th-from-top) * 3|LENGTHCONV + COPYING|
|OP_TUCK|length(A) * 3|COPYING|
|OP_ROLL|wordspan(A) * 2 + 48 * Value of A|LENGTHCONV + ROLL|
||
...
|-|-|
|OP_BOOLAND|(wordspan(A) + wordspan(B)) * 2|COMPARINGZERO|
|OP_BOOLOR|(wordspan(A) + wordspan(B)) * 2|COMPARINGZERO|
|OP_NUMEQUAL|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_NUMEQUALVERIFY|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_NUMNOTEQUAL|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_LESSTHAN|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_GREATERTHAN|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_LESSTHANOREQUAL|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_GREATERTHANOREQUAL|MAX(wordspan(A), wordspan(B)) * 2|COMPARING + COMPARINGZERO|
|OP_MIN|MAX(wordspan(A), wordspan(B)) * 4|OTHER|
|OP_MAX|MAX(wordspan(A), wordspan(B)) * 4|OTHER|
|OP_WITHIN|(MAX(wordspan(C), wordspan(B)) + MAX(wordspan(C), wordspan(A))) * 2|COMPARING + COMPARINGZERO|
