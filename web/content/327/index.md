...
*  Inputs:
    ...
    *  The tweak modes _is_xonly_t<sub>1..v</sub>_ : _v_ booleans
    *  The message _m_: a byte array<ref name="mlen" />
    *  The index of the signer _i_ in the public nonces and individual public keys with _0 < i &le; u_
...
*  Inputs:
    ...
    *  The _session_ctx_: a <a href=" session-context" target="_blank">Session Context</a> data structure
*  Let _(Q, _, tacc, _, R, e) = GetSessionValues(session_ctx)_; fail if that fails
*  For _i = 1 .. u_:
...
*  **1.0.4** (2026-08-19):
    *  Fix two minor bugs in the specification of _PartialSigAgg_.
*  **1.0.3** (2026-01-05):
