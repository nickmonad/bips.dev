...
:   A compact size unsigned integer representing the type. This compact
    ...
    byte. This must be unique within a specific `<map>`{=html}.
...
`</ref>`{=html} followed by a separator of `0xFF` [^2]. This integer
must be serialized in most significant byte order.
...
|----------------------|----------------------------------|-----------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|------------------------------|-----------------------------|------------|
| Unsigned Transaction | `PSBT_GLOBAL_UNSIGNED_TX = 0x00` | None                                                                                          | No key data                                                                                                                                                                                                                                                                                                                               | `<transaction>`{=html}         | The transaction in network serialization. The scriptSigs and witnesses for each input must be empty. The transaction must be in the old serialization format (without witnesses).                                                                                                                                                  | 0                            |                              | 0                           | 174        |
| Extended Public Key  | `PSBT_GLOBAL_XPUB = 0x01`        | `<xpub>`{=html}                                                                               | The 78 byte serialized extended public key as defined by BIP 32. Extended public keys are those that can be used to derive public keys used in the inputs and outputs of this transaction. It should be the public key at the highest hardened derivation index so that the unhardened child keys used in the transaction can be derived. | `<32-bit uint> <32-bit uint>*` | The master key fingerprint as defined by BIP 32 concatenated with the derivation path of the public key. The derivation path is represented as 32-bit little endian unsigned integer indexes concatenated with each other. The number of 32 bit unsigned integer indexes must match the depth provided in the extended public key. |                              |                              | 0                           | 174        |
...
| Proprietary Use Type | `PSBT_GLOBAL_PROPRIETARY = 0xFC` | `<identifierlen>`{=html}` ``<identifier>`{=html}` ``<subtype>`{=html}` ``<subkeydata>`{=html} | Compact size unsigned integer `<identifierlen>`{=html}, followed by identifier prefix of that length `<identifer>`{=html}, followed by a subtype `<subtype>`{=html}, followed by the key data itself `<subkeydata>`{=html}.                                                                                                               | `<data>`{=html}                | Any value data as defined by the proprietary type user.                                                                                                                                                                                                                                                                            |                              |                              | 0                           | 174        |
...
| Witness UTXO                 | `PSBT_IN_WITNESS_UTXO = 0x01`        | None                                                                                          | No key data                                                                                                                                                                                                                 | `<64-bit uint> ``<scriptPubKeylen>`{=html}` ``<scriptPubKey>`{=html} | The entire transaction output in network serialization which the current input spends from. This should only be present for inputs which spend segwit outputs, including P2SH embedded ones. An input can have both `PSBT_IN_NON_WITNESS_UTXO` and `PSBT_IN_WITNESS_UTXO`                                                                     |                              |                              | 0                           | 174                                  |
| Partial Signature            | `PSBT_IN_PARTIAL_SIG = 0x02`         | `<pubkey>`{=html}                                                                             | The public key which corresponds to this signature.                                                                                                                                                                         | `<signature>`{=html}                                                 | The signature as would be pushed to the stack from a scriptSig or witness.                                                                                                                                                                                                                                                                    |                              |                              | 0                           | 174                                  |
...
| Redeem Script                | `PSBT_IN_REDEEM_SCRIPT = 0x04`       | None                                                                                          | No key data                                                                                                                                                                                                                 | `<redeemScript>`{=html}                                              | The redeemScript for this input if it has one.                                                                                                                                                                                                                                                                                                |                              |                              | 0                           | 174                                  |
| Witness Script               | `PSBT_IN_WITNESS_SCRIPT = 0x05`      | None                                                                                          | No key data                                                                                                                                                                                                                 | `<witnessScript>`{=html}                                             | The witnessScript for this input if it has one.                                                                                                                                                                                                                                                                                               |                              |                              | 0                           | 174                                  |
| BIP 32 Derivation Path       | `PSBT_IN_BIP32_DERIVATION = 0x06`    | `<pubkey>`{=html}                                                                             | The public key                                                                                                                                                                                                              | `<32-bit uint> <32-bit uint>*`                                       | The master key fingerprint as defined by BIP 32 concatenated with the derivation path of the public key. The derivation path is represented as 32 bit unsigned integer indexes concatenated with each other. Public keys are those that will be needed to sign this input.                                                                    |                              |                              | 0                           | 174                                  |
| Finalized scriptSig          | `PSBT_IN_FINAL_SCRIPTSIG = 0x07`     | None                                                                                          | No key data                                                                                                                                                                                                                 | `<scriptSig>`{=html}                                                 | The Finalized scriptSig contains a fully constructed scriptSig with signatures and any other scripts necessary for the input to pass validation.                                                                                                                                                                                              |                              |                              | 0                           | 174                                  |
| Finalized scriptWitness      | `PSBT_IN_FINAL_SCRIPTWITNESS = 0x08` | None                                                                                          | No key data                                                                                                                                                                                                                 | `<scriptWitness>`{=html}                                             | The Finalized scriptWitness contains a fully constructed scriptWitness with signatures and any other scripts necessary for the input to pass validation.                                                                                                                                                                                      |                              |                              | 0                           | 174                                  |
| Proof-of-reserves commitment | `PSBT_IN_POR_COMMITMENT = 0x09`      | None                                                                                          | No key data                                                                                                                                                                                                                 | `<porCommitment>`{=html}                                             | The UTF-8 encoded commitment message string for the proof-of-reserves. See [BIP 127](bip-0127.mediawiki "wikilink") for more information.                                                                                                                                                                                                     |                              |                              | 0                           | [127](bip-0127.mediawiki "wikilink") |
| RIPEMD160 preimage           | `PSBT_IN_RIPEMD160 = 0x0a`           | `<20-byte hash>`                                                                              | The resulting hash of the preimage                                                                                                                                                                                          | `<preimage>`{=html}                                                  | The hash preimage, encoded as a byte vector, which must equal the key when run through the `RIPEMD160` algorithm                                                                                                                                                                                                                              |                              |                              | 0                           | 174                                  |
| SHA256 preimage              | `PSBT_IN_SHA256 = 0x0b`              | `<32-byte hash>`                                                                              | The resulting hash of the preimage                                                                                                                                                                                          | `<preimage>`{=html}                                                  | The hash preimage, encoded as a byte vector, which must equal the key when run through the `SHA256` algorithm                                                                                                                                                                                                                                 |                              |                              | 0                           | 174                                  |
| HASH160 preimage             | `PSBT_IN_HASH160 = 0x0c`             | `<20-byte hash>`                                                                              | The resulting hash of the preimage                                                                                                                                                                                          | `<preimage>`{=html}                                                  | The hash preimage, encoded as a byte vector, which must equal the key when run through the `SHA256` algorithm followed by the `RIPEMD160` algorithm                                                                                                                                                                                           |                              |                              | 0                           | 174                                  |
| HASH256 preimage             | `PSBT_IN_HASH256 = 0x0d`             | `<32-byte hash>`                                                                              | The resulting hash of the preimage                                                                                                                                                                                          | `<preimage>`{=html}                                                  | The hash preimage, encoded as a byte vector, which must equal the key when run through the `SHA256` algorithm twice                                                                                                                                                                                                                           |                              |                              | 0                           | 174                                  |
| Proprietary Use Type         | `PSBT_IN_PROPRIETARY = 0xFC`         | `<identifierlen>`{=html}` ``<identifier>`{=html}` ``<subtype>`{=html}` ``<subkeydata>`{=html} | Compact size unsigned integer `<identifierlen>`{=html}, followed by identifier prefix of that length `<identifer>`{=html}, followed by a subtype `<subtype>`{=html}, followed by the key data itself `<subkeydata>`{=html}. | `<data>`{=html}                                                      | Any value data as defined by the proprietary type user.                                                                                                                                                                                                                                                                                       |                              |                              | 0                           | 174                                  |

The currently defined per-output [^4] types are defined as follows:

| Name                   | `<keytype>`{=html}                 | `<keydata>`{=html}                                                                            | `<keydata>`{=html} Description                                                                                                                                                                                              | `<valuedata>`{=html}            | `<valuedata>`{=html} Description                                                                                                                                                                                                                         | Versions Requiring Inclusion | Versions Requiring Exclusion | Versions Allowing Inclusion | Parent BIP |
|------------------------|------------------------------------|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------|------------------------------|-----------------------------|------------|
| Redeem Script          | `PSBT_OUT_REDEEM_SCRIPT = 0x00`    | None                                                                                          | No key data                                                                                                                                                                                                                 | `<redeemScript>`{=html}         | The redeemScript for this output if it has one.                                                                                                                                                                                                          |                              |                              | 0                           | 174        |
| Witness Script         | `PSBT_OUT_WITNESS_SCRIPT = 0x01`   | None                                                                                          | No key data                                                                                                                                                                                                                 | `<witnessScript>`{=html}        | The witnessScript for this output if it has one.                                                                                                                                                                                                         |                              |                              | 0                           | 174        |
| BIP 32 Derivation Path | `PSBT_OUT_BIP32_DERIVATION = 0x02` | `<public key>`{=html}                                                                         | The public key                                                                                                                                                                                                              | `<{32-bit uint> <32-bit uint>*` | The master key fingerprint concatenated with the derivation path of the public key. The derivation path is represented as 32-bit little endian unsigned integer indexes concatenated with each other. Public keys are those needed to spend this output. |                              |                              | 0                           | 174        |
| Proprietary Use Type   | `PSBT_OUT_PROPRIETARY = 0xFC`      | `<identifierlen>`{=html}` ``<identifier>`{=html}` ``<subtype>`{=html}` ``<subkeydata>`{=html} | Compact size unsigned integer `<identifierlen>`{=html}, followed by identifier prefix of that length `<identifer>`{=html}, followed by a subtype `<subtype>`{=html}, followed by the key data itself `<subkeydata>`{=html}. | `<data>`{=html}                 | Any value data as defined by the proprietary type user.                                                                                                                                                                                                  |                              |                              | 0                           | 174        |
