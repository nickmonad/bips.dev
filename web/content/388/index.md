...
We remark that wallet policies are not related to the _policy_ language, a higher level language that can be compiled to miniscript.

<h3> Security and UX concerns for hardware signing devices </h3>
