...
encoding process. Slice base64 result string on index 0 to \`pwd\_len\`.
This slice is the password. As \`pwd\_len\` is limited to 86, passwords
...
index 0 to \`pwd\_len\`. This slice is the password. \`pwd\_len\` is
